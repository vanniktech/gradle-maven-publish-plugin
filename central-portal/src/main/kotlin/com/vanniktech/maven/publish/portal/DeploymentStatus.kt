...
/**
 * Response from the Central Portal API status endpoint. See
...
internal enum class DeploymentState {
  ...
  /**
   * A deployment has passed validation and is waiting on a user to manually publish via the Central
   * Portal UI
   */
  VALIDATED,

  /**
   * A deployment has been either automatically or manually published and is being uploaded to Maven
   * Central
   */
  PUBLISHING,
