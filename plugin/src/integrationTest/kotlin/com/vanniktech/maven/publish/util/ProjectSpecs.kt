...
fun javaProjectSpec() =
  ProjectSpec(
    plugins = listOf(javaPlugin),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
    sourceFiles =
      listOf(SourceFile("main", "java", "com/vanniktech/maven/publish/test/JavaTestClass.java")),
    basePluginConfig = "configure(new JavaLibrary(new JavadocJar.Empty(), true))",
  )

fun javaLibraryProjectSpec() =
  ProjectSpec(
    plugins = listOf(javaLibraryPlugin),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun javaGradlePluginProjectSpec() =
  ProjectSpec(
    plugins = listOf(javaGradlePluginPlugin),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun javaGradlePluginWithGradlePluginPublish(
...
fun javaGradlePluginKotlinProjectSpec(version: KgpVersion): ProjectSpec {
  ...
  return plainJavaGradlePluginProject.copy(
    ...
    sourceFiles =
      plainJavaGradlePluginProject.sourceFiles +
        listOf(
...
fun kotlinJvmProjectSpec(version: KgpVersion) =
  ProjectSpec(
    plugins = listOf(kotlinJvmPlugin.copy(version = version.value)),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun kotlinMultiplatformProjectSpec(version: KgpVersion) =
  ProjectSpec(
    plugins = listOf(kotlinMultiplatformPlugin.copy(version = version.value)),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
    sourceFiles =
      listOf(
        SourceFile(
          "commonMain",
          "kotlin",
          "com/vanniktech/maven/publish/test/ExpectedTestClass.kt",
        ),
...
fun kotlinMultiplatformWithAndroidLibraryProjectSpec(
  ...
  return baseProject.copy(
    ...
    sourceFiles =
      baseProject.sourceFiles +
        listOf(
          SourceFile(
            "androidMain",
            "kotlin",
            "com/vanniktech/maven/publish/test/AndroidTestClass.kt",
          ),
          SourceFile(
            "androidDebug",
            "kotlin",
    ...
    basePluginConfig =
      "configure(new KotlinMultiplatform(new JavadocJar.Empty(), true, [\"release\"]))",
    buildFileExtra =
      baseProject.buildFileExtra +
        """
...
fun kotlinMultiplatformWithModernAndroidLibraryProjectSpec(
  agpVersion: AgpVersion,
  kgpVersion: KgpVersion,
): ProjectSpec {
  val baseProject = kotlinMultiplatformProjectSpec(kgpVersion)
  return baseProject.copy(
    plugins =
      baseProject.plugins +
        listOf(androidMultiplatformLibraryPlugin.copy(version = agpVersion.value)),
    sourceFiles =
      baseProject.sourceFiles +
        listOf(
          SourceFile(
...
fun androidLibraryProjectSpec(version: AgpVersion) =
  ProjectSpec(
    plugins = listOf(androidLibraryPlugin.copy(version = version.value)),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun androidLibraryKotlinProjectSpec(agpVersion: AgpVersion, kgpVersion: KgpVersion): ProjectSpec {
  ...
  return plainAndroidProject.copy(
    plugins = plugins,
    sourceFiles =
      plainAndroidProject.sourceFiles +
        listOf(
          SourceFile("main", "kotlin", "com/vanniktech/maven/publish/test/KotlinTestClass.kt")
        ),
    buildFileExtra =
      plainAndroidProject.buildFileExtra +
        """
...
fun androidFusedLibraryProjectSpec(version: AgpVersion) =
  ProjectSpec(
    plugins = listOf(androidFusedLibraryPlugin.copy(version = version.value)),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun javaPlatformProjectSpec() =
  ProjectSpec(
    plugins = listOf(javaPlatformPlugin),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
...
fun versionCatalogProjectSpec() =
  ProjectSpec(
    plugins = listOf(versionCatalogPlugin),
    group = "com.example",
    artifactId = "test-artifact",
    version = "1.0.0",
    properties = defaultProperties,
