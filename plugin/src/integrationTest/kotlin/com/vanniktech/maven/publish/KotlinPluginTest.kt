...
import com.vanniktech.maven.publish.util.kotlinMultiplatformWithAndroidProjectSpec
...
class KotlinPluginTest : BasePluginTest() {
  ...
  @TestParameterInjectorTest
  fun kotlinMultiplatformWithAndroidProject(
    ...
    val project = kotlinMultiplatformWithAndroidProjectSpec(agpVersion, kgpVersion)
    val result = project.run()
